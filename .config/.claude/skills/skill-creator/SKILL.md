...
license: Apache-2.0 (derived from github.com/anthropics/skills)
---
...
Then populate SKILL.md with the required frontmatter:
...
- `name`: The skill name (lowercase, hyphens, 1-64 chars, must match directory name)
